...
const homeJsonLd = [
  {
    ...
    description: '面向留学生的一站式求职平台，提供职位搜索、AI 面试、校招日历、薪资查询和求职规划。',
  },
  {
    '@context': 'https://schema.org',
    '@type': 'WebSite',
...
const features = [
  ...
  },
  {
    ...
    bg: 'bg-indigo-50',
    title: '笔经面经',
    description: '按公司、岗位和地区整理真实面试经验，沉淀高频考点。',
  },
  {
    icon: <Bot className="w-6 h-6 text-purple-600" />,
    bg: 'bg-purple-50',
    title: 'AI 面试',
    description: '模拟行为面试和技术面试，给出评分、追问和改进建议。',
  },
  {
      ...
      <div className="border-r border-gray-100 p-5 bg-gray-50/70 overflow-hidden">
        ...
        <div className="space-y-3">
          {['Frontend Engineer', 'Full Stack Developer', 'Data Scientist'].map((title, index) => (
            <div
              key={title}
              className={`p-4 rounded-xl border bg-white ${index === 0 ? 'border-primary ring-1 ring-primary/20' : 'border-gray-200'}`}
            >
        ...
        <div className="space-y-6">
          ...
          <div className="p-4 rounded-xl bg-indigo-50 border border-indigo-100 flex items-center justify-between gap-4">
            <div>
              ...
              <div className="text-xs text-indigo-600 mt-1">基于该岗位生成高频面试题和回答建议</div>
            </div>
  ...
  <section className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center overflow-hidden">
    ...
    >
      ...
      <p className="text-lg md:text-xl text-gray-500 max-w-2xl mx-auto mb-10 leading-relaxed font-medium">
        职位搜索、网申助手、笔经面经、AI 模拟面试、薪资查询、简历优化、校招日历和求职规划，帮你把复杂求职流程拆成清晰行动。
      </p>

      <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
        <Link
          to="/jobs"
          className="group w-full sm:w-auto px-8 py-4 bg-gray-900 hover:bg-black text-white rounded-xl text-base font-bold transition-all shadow-[0_10px_30px_-10px_rgba(0,0,0,0.4)] flex items-center justify-center"
        >
          开始搜索职位
        ...
        <Link
          to="/ai-interview"
          className="w-full sm:w-auto px-8 py-4 bg-white border border-gray-200 hover:border-gray-300 hover:bg-gray-50 text-gray-900 rounded-xl text-base font-bold transition-all flex items-center justify-center shadow-sm"
        >
          体验 AI 模拟面试
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <div className="space-y-6 mb-8">
            {[
              ...
              {
                title: '留学生专属筛选',
                desc: '快速定位支持 OPT、CPT、H1B 或 E-Verify 的目标公司。',
                Icon: Filter,
        ...
        <motion.div
          ...
          className="rounded-2xl bg-gray-50 border border-gray-200 p-3 shadow-xl"
        >
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
          <button
            ...
            className="w-full sm:w-auto px-8 py-4 bg-white text-gray-900 hover:bg-gray-100 rounded-xl text-lg font-bold transition-all shadow-[0_0_40px_rgba(255,255,255,0.18)] flex items-center justify-center"
          >
            免费注册账号
          ...
          <button
            ...
            className="w-full sm:w-auto px-8 py-4 bg-gray-800 text-white border border-gray-700 hover:bg-gray-700 hover:border-gray-600 rounded-xl text-lg font-bold transition-colors flex items-center justify-center"
          >
            登录继续使用
          </button>
        </div>
